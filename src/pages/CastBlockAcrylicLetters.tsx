...
const CastBlockAcrylicLetters = () => {
  ...
  const features = [
    ...
    "Premium cast cell acrylic construction",
  ];
  ...
  const structuredData = {
    ...
    description:
      "Premium thick-cast acrylic letters with precision CNC cutting with fast delivery and superior service.",
    brand: {
      "@type": "Brand",
      name: "Sunlite Signs",
    },
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl mb-8 opacity-90">
                Premium thick-cast acrylic letters with precision CNC cutting
                and polished edges. Superior quality with faster delivery and
                better service.
              </p>
              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                <div>
                  <h2 className="text-3xl font-bold text-foreground mb-6">
                    Why Cast Block Acrylic Letters
                  </h2>
                  <div className="prose prose-lg text-muted-foreground">
                    <p className="mb-4">
                      Cast block acrylic letters represent the premium choice
                      for dimensional signage. Unlike extruded acrylic or vinyl
                      letters, cast acrylic offers superior optical clarity,
                      consistent thickness, and exceptional edge quality when
                      precision cut.
                    </p>
                    <p className="mb-4">
                      Our precision CNC cutting process ensures perfectly
                      smooth, polished edges that catch and reflect light
                      beautifully. The thick dimensional profile creates
                      impressive depth and shadow lines that make your signage
                      stand out from flat alternatives.
                    </p>
                    <p>
                      We use only premium cast cell acrylic - the same grade
                      used by high-end architectural signage manufacturers, but
                      with faster turnaround and better customer service.
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      <div className="w-8 h-8 bg-primary rounded-full flex items-center justify-center text-primary-foreground font-bold text-sm mr-4 mt-1">
                        1
                      </div>
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Premium cast cell acrylic sheets, inspected for
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Computer-controlled routing for perfect letter shapes
                          and smooth edges.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          All cut edges are flame polished to crystal clarity as
                          standard.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Final inspection and mounting hardware preparation
                          before shipping.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Pantone color matching available for any custom color
                          requirement.
                        </p>
                      </div>
                    </div>
